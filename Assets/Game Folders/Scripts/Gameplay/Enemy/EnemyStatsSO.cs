...
[CreateAssetMenu(fileName = "EnemyStats_Default", menuName = "The Day After/Enemy/Enemy Stats")]
public class EnemyStatsSO : ScriptableObject
{
    ...
    [SerializeField, Range(0f, 1f)] private float suspiciousThreshold = 0.35f;
