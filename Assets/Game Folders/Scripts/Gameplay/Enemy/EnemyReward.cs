...
public class EnemyReward : MonoBehaviour
{
    ...
    private void Awake()
    {
        purification ??= GetComponent<EnemyPurification>();
    ...
    {
        if (purification != null) purification.OnPurified += HandlePurified;
    }
    ...
    private void CacheSanityController()
    {
        ...
        if (enemyController == null || !enemyController.HasTarget) return;
    ...
    private void HandlePurified()
    {
        ...
        {
            Debug.LogWarning("[EnemyReward] SanityController tidak ditemukan.", this);
            return;
        }

        if (enemyController == null || enemyController.Stats == null)
        {
            Debug.LogWarning("[EnemyReward] EnemyStatsSO tidak ditemukan.", this);
            return;
        }

        float reward = enemyController.Stats.PurificationSanityReward;
